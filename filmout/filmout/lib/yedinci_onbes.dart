...
class YedinciOnBes extends StatefulWidget {
  const YedinciOnBes({super.key});

  @override
  State<YedinciOnBes> createState() => _YedinciOnBesState();
}

class _YedinciOnBesState extends State<YedinciOnBes> {

    // 4-) Burada youtube videosu ekliyoruz.(Video değişkeninden sonraki koda git.)
  final videoURL = "https://youtu.be/MsnF1YSQpYE";
...
//İkonu Mail Adresine Yönlendirme Bitiş
          ...
          body: ListView(
            children: [
              Card(
                child: Text(
                  "Aşk Tesadüfleri Sever Yedinci 15 Dakika",
