...
class IkinciOnBes extends StatefulWidget {
  const IkinciOnBes({super.key});

  @override
  State<IkinciOnBes> createState() => _IkinciOnBesState();
}

class _IkinciOnBesState extends State<IkinciOnBes> {
  // 4-) Burada youtube videosu ekliyoruz.(Video değişkeninden sonraki koda git.)
  final videoURL = "https://youtu.be/pMn_nBBHGss";
...
//İkonu Mail Adresine Yönlendirme Bitiş
          ...
          body: ListView(
            children: [
              Card(
                child: Text(
                  "Aşk Tesadüfleri Sever İkinci 15 Dakika",
