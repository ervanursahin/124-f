...
class UcuncuOnBes extends StatefulWidget {
  const UcuncuOnBes({super.key});

  @override
  State<UcuncuOnBes> createState() => _UcuncuOnBesState();
}

class _UcuncuOnBesState extends State<UcuncuOnBes> {
  // 4-) Burada youtube videosu ekliyoruz.(Video değişkeninden sonraki koda git.)
  final videoURL = "https://youtu.be/A9WUn0MHRRw";
...
//İkonu Mail Adresine Yönlendirme Bitiş
          ...
          body: ListView(
            children: [
              Card(
                child: Text(
                  "Aşk Tesadüfleri Sever Üçüncü 15 Dakika",
