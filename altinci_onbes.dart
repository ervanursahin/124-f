...
class AltinciOnBes extends StatefulWidget {
  const AltinciOnBes({super.key});

  @override
  State<AltinciOnBes> createState() => _AltinciOnBesState();
}

class _AltinciOnBesState extends State<AltinciOnBes> {

    // 4-) Burada youtube videosu ekliyoruz.(Video değişkeninden sonraki koda git.)
  final videoURL = "https://youtu.be/7dTUc9NHLGM";
...
//İkonu Mail Adresine Yönlendirme Bitiş
          ...
          body: ListView(
            children: [
              Card(
                child: Text(
                  "Aşk Tesadüfleri Sever Altıncı 15 Dakika",
