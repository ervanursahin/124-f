...
class DorduncuOnBes extends StatefulWidget {
  const DorduncuOnBes({super.key});

  @override
  State<DorduncuOnBes> createState() => _DorduncuOnBesState();
}

class _DorduncuOnBesState extends State<DorduncuOnBes> {

  // 4-) Burada youtube videosu ekliyoruz.(Video değişkeninden sonraki koda git.)
  final videoURL = "https://youtu.be/1JMWeJNaAcE";
...
//İkonu Mail Adresine Yönlendirme Bitiş
          ...
          body: ListView(
            children: [
              Card(
                child: Text(
                  "Aşk Tesadüfleri Sever Dördüncü 15 Dakika",
